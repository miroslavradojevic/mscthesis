...
\begin{figure}%[htb]
  \centering
    \subfigure[Straight trajectory: LBL outliers erroneously rejected (red). EKF tends to recover navigation (green).] {\label{fig:straight-median-ekf}
	\includegraphics[width=0.45\linewidth]{results/fig/straight-median-ekf.eps}}
    ...
    \subfigure[Spiral trajectory: LBL outliers rejected using median. EKF filtering results in the position disturbance which recovers soon after.] {\label{fig:spiral-median-ekf}
