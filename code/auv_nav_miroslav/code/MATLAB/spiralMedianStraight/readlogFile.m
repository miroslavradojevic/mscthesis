...
HOW_MUCH=50;
figure;
plot(OldNav(1:end-HOW_MUCH,2), OldNav(1:end-HOW_MUCH,1), 'y-.'); hold on; axis equal; grid on;
plot(OldNav(1:end-HOW_MUCH,2), OldNav(1:end-HOW_MUCH,1), 'r.');
plot(Obs(1:end-HOW_MUCH,2), Obs(1:end-HOW_MUCH,1), 'bo');
...
if(EXPORT_IMAGES),
            set(gcf, 'Color', 'none');  
            export_fig spiral-median-ekf.eps -eps -a1;
end
