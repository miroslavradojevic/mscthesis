#ifndef _NAV_EKF_ROSREAD_H_
#define _NAV_EKF_ROSREAD_H_
// ================================================================== includes
#include <vector>
#include <sstream>
...
private:
	...
	float northNAV, northLBL,  eastNAV, eastLBL; // auxilliary
