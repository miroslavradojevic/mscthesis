...
if(EXPORT_IMAGES),
            set(gcf, 'Color', 'none');  
            export_fig square2NoGps.eps -eps -a1;
end
...
plot(time(1:LENGTH), OutputMessages(1:LENGTH,8) *180/pi, 'r', 'LineWidth', 1.6);
...
plot(time(1:LENGTH), OutputMessages(1:LENGTH,10), 'r', 'LineWidth', 1.6); grid on;
...
plot(time(1:LENGTH), OutputMessages(1:LENGTH,5), 'r', 'LineWidth', 1.6);
...
plot(time(1:LENGTH), OutputMessages(1:LENGTH,6), 'r', 'LineWidth', 1.6);
